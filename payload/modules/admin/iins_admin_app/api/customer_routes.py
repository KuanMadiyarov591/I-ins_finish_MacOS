...
from iins_admin_app.api.helpers import application_out, policy_out, question_out
from iins_admin_app.auth import require_customer
from iins_admin_app.config import ROOT
...
from iins_admin_app.schemas import (
    ClaimIn,
    ClaimOut,
    ClientDocumentIn,
    ClientDocumentOut,
