"""Build and query the local administrator I-ins PDF RAG corpus.
...
def _title_from_filename(path: Path) -> str:
    value = re.sub(
        r"^(?:01_\d+_client_and_02_insurance_agent_and_04_admin_|04_\d+_admin_|04_admin_internal_\d+_\d+_|04_admin_Razrabotchik_IT_)",
        "",
        path.stem,
        flags=re.IGNORECASE,
    )
...
def validate_retrieval() -> dict:
    cases = [
        {
            "query": "как администратору назначать роли и журналировать действия",
            "expected_sources": ["04_admin_internal_01_"],
        },
        {
            "query": "система менеджмента искусственного интеллекта управление рисками",
            "expected_sources": ["04_admin_Razrabotchik_IT_GOST_R_42001"],
        },
        {
            "query": "жизненный цикл системы искусственного интеллекта стадии",
            "expected_sources": ["04_admin_Razrabotchik_IT_GOST_R_71539"],
        },
        {
            "query": "требования к защите персональных данных в информационной системе",
            "expected_sources": ["04_03_", "04_04_", "01_07_"],
        },
        {
            "query": "обеспечение информационной безопасности финансовой организации требования 757-П",
            "expected_sources": ["04_01_"],
        },
    ]
    results = []
    for case in cases:
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Build and query the administrator I-ins PDF RAG store")
