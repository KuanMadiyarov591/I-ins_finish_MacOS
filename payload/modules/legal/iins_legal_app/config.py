...
class Settings(BaseSettings):
    ...
    app_port: int = 8005
    secret_key: str = "legal-hub-demo-secret-change-me"
    database_url: str = f"sqlite:///{(ROOT / 'data' / 'legal_hub.db').as_posix()}"
    corpus_dir: Path = ROOT / "iins_legal_app" / "data" / "legal_rag_corpus"
    docs_storage_dir: Path = ROOT / "data" / "legal_docs"
    rag_vector_db_path: Path = ROOT / "knowledge_base" / "rag_store" / "vectors.sqlite3"
    model_dir: Path = ROOT / "models" / "lawyer"
