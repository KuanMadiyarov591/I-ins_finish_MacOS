...
def backend_ready(backend: str) -> bool:
    ...
    if backend == "gigachat":
        try:
            from iins_underwriter_app.services.gigachat_lm import gigachat_is_ready
...
def not_ready_message(backend: str) -> str:
    ...
    if backend == "gigachat":
        try:
            from iins_underwriter_app.services.gigachat_lm import gigachat_status
...
def generate_reply(
    ...
    *,
    ...
    if backend == "gigachat":
        from iins_underwriter_app.services.gigachat_lm import generate_gigachat_reply
