...
from iins_client_app.api import admin_routes, auth_routes, company_admin_routes, customer_routes, rag_routes, recommender_routes
from iins_client_app.config import ROOT, get_settings
from iins_client_app.db import Base, SessionLocal, engine, migrate_sqlite_schema
from iins_client_app.seed import seed_if_empty
from iins_client_app.company_db import company_db_ping
...
def _instrument_metrics(app: FastAPI) -> None:
    try:
        ...
        from iins_client_app.services.metrics_compat import apply_route_name_shim
