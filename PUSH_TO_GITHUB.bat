...
if errorlevel 1 (
  git -c user.name="Kuan Madiyarov" -c user.email="kukamadchemical@gmail.com" commit -m "Analysis tab: distribution fitting and tariff sensitivity for the actuary, decision-threshold explorer for the underwriter"
)
